...
Visualize your data: Make a plot of distance vs. delay, with count
...
![](Data-Wrangling_files/figure-gfm/unnamed-chunk-37-1.png)<!-- -->
...
![](Data-Wrangling_files/figure-gfm/unnamed-chunk-39-1.png)<!-- -->
...
![](Data-Wrangling_files/figure-gfm/unnamed-chunk-40-1.png)<!-- -->
...
![](Data-Wrangling_files/figure-gfm/unnamed-chunk-41-1.png)<!-- -->
...
eithera count (n(), or a count of non-missing values (sum(\!is.na(x))).
HTat way you an check that you’re not drawing conclusions based on very
small amounts of data. For example, let’s look at the planes(identified
by their tail nubmer) that have the highest average delay:
...
There is much greater variation in the average delay when there are
fewer flights. The shape of this plot (inverse of a bell curve).
...
![](Data-Wrangling_files/figure-gfm/unnamed-chunk-48-1.png)<!-- -->
